    ...
    return (
        <PageLayout>
            <main className='bg-barrel-green '>
                ...
                <p className='text-white text-2xl font-hansief font-bold text-center bg-barrel-green pt-10 tracking-wide'>
                    PAYOUT : $638.83
                </p>

                <section className='flex justify-center pt-10 bg-barrel-green' id="dashboardToggle">
                ...
                <h2 className='text-white underline underline-offset-3 font-hansief text-2xl font-bold text-center bg-barrel-green pt-10 tracking-wide'>
                    PENDING BIDS
                </h2>
                <section className='bg-barrel-green'>
